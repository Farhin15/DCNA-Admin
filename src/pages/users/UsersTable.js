...
//     };
// }
function createData(id, name, satge, requestType, daysLeft, extended, createdDate, source, completed) {
    return {
        id,
        name,
        satge,
                            ...
                            {visibleRows.map((row, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell>{row.satge}</TableCell>
                                        <TableCell>{row.requestType}</TableCell>
                                        <TableCell>{row.daysLeft}</TableCell>
                                        <TableCell>{row.extended ? 'Yes' : 'No'}</TableCell>
